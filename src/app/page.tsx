...
const features = [
  ...
  },
  {
    ...
    description:
      "Real reviews from real guests who have stayed at the property.",
  },
  {
    icon: <FiClock className="text-2xl" />,
    title: "24/7 Support",
    description:
      "Our team is available around the clock to help with your booking.",
  },
  {
...
export default function HomePage() {
  ...
  return (
    <div>
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-white/90 text-sm font-medium">
                Discover amazing stays worldwide
              </span>
            </div>
            ...
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
              Explore thousands of hotels, resorts, and unique stays. Book with
      ...
      <section className="page-container">
        <div className="text-center mb-10">
          ...
          <p className="section-subtitle">
            Explore trending cities loved by travelers
          </p>
        </div>
      ...
      {/* Featured Hotels */}
      <section className="w-full bg-white py-16 md:py-24 border-y border-secondary-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header - Centered */}
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="section-title">Featured Hotels</h2>
            <p className="section-subtitle mt-2">
              Handpicked hotels for exceptional stays
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <Link
              href="/search"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary-600 text-white rounded-xl font-medium hover:bg-primary-700 transition-colors shadow-sm hover:shadow-md"
            >
              View All Hotels →
            </Link>
          </div>
      ...
      <section className="page-container">
        <div className="text-center mb-10">
          ...
          <p className="section-subtitle">
            We make hotel booking simple, secure, and delightful
          </p>
        </div>
      ...
      <section className="page-container">
        <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-3xl p-8 md:p-12 text-center">
          ...
          <p className="text-white/80 mb-6 max-w-lg mx-auto">
            Sign up today and get exclusive access to deals, early bird
